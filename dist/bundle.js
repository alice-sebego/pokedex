 ...
 */
var setBackgroundColor = function setBackgroundColor(type, card) {
  switch (type) {
    case "grass":
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setMsgError404": () => (/* binding */ setMsgError404),
/* harmony export */   "setMsgError": () => (/* binding */ setMsgError)
/* harmony export */ });
/**
 * Set a message when we have a 404 error
 * @param {HTMLElement} elementHTML 
 */
var setMsgError404 = function setMsgError404(elementHTML) {
  var msgError = document.createElement("div");
  msgError.setAttribute("id", "error");
  msgError.innerHTML = "<img src=\"https://media.giphy.com/media/JPKmhwbO5zX1u/giphy.gif\" alt=\"Donn\xE9es non fournies d\xE9sol\xE9\" /><p>Ooh nooo ! Nous n'avons pas pu recevoir les donn\xE9es de notre fournisseur de donn\xE9es<br>Un coup de la team Rocket, sans doute :/</p>";
...
var setMsgError = function setMsgError(elementHTML, errorDescription) {
  var msgError = document.createElement("div");
  msgError.setAttribute("id", "error");
  msgError.innerHTML = "<img src=\"https://media.giphy.com/media/l0HluqguCBcvwCvBu/giphy.gif\" alt=\"Donn\xE9es non fournies d\xE9sol\xE9\" /><p>Ooh nooo ! Erreur : ".concat(errorDescription, "<br>Nous n'avons pas pu recevoir les donn\xE9es de notre fournisseur de donn\xE9es<br>Un coup de la team Rocket, sans doute :/</p>");
  elementHTML.appendChild(msgError);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bgcolor_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(332);
/* harmony import */ var _handle_error_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(333);
...
var urlAllPokemon = "https://pokeapi.co/api/v2/pokemon?limit=101"; // Array where we store name or datas of each pokemon
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            arr.push(responseJson.results); // add datalist
...
var fetchInfoEachPokemon = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(pokemon) {
    var data, dataJson, name, picture, idPokemon, typePokemon, $card;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return fetch(urlEachPokemon + pokemon);
          ...
          case 7:
            ...
            name = dataJson.name;
            picture = dataJson.sprites.front_default;
            idPokemon = dataJson.id;
            typePokemon = dataJson.types[0].type.name;
...
$inputForm.addEventListener("input", function (e) {
  ...
  var $cards = cardsName.filter(function (pokemon) {
    return pokemon.toLowerCase().includes(element);
  });
